...
const Orders = () => {
    ...
    const fetchAllorders = async () => {
        try {
            let { data } = await axios.get(`${Api.url}/orders/allorders`, {
                headers: {
                                                        ...
                                                        <h2>
                                                            <AccordionButton _expanded={{ bg: '#ff914d' }}>
                                                                <Box flex='1' textAlign='left'>
                                                                    ...
                                                                    <Text>UserID: {orders.userId}</Text>
                                                                </Box>
                                                                <AccordionIcon />
                                                            </AccordionButton>
                                                        </h2>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <Text fontSize='14px'>Style No: {item.prod_style_no}</Text>
                                                                                    </Box>
                                                                                </Box>
                                                                                <Box display='flex'
                                                                            ...
                                                                            orders.address.map((adrs) => {
                                                                                return (
                                                                                    <Box display='flex'
                                                                                        ...
                                                                                        <Box>
                                                                                            <Text textDecoration='underline'>Payment Order ID</Text>
                                                                                            <Text>{orders.razorpay_order_id}</Text>
                                                                                        </Box>
                                                                                        <Box>
                                                                                            <Text textDecoration='underline'>Delivery Address</Text>
                                                                                            <p>{adrs.name}</p>
