    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                let { data } = await axios.put(`${Api.url}/products/editproduct/${id}`, values, {
                    headers: {
                        Authorization: `${localStorage.getItem("menzee_authToken")}`,
                    },
                })
    ...
    return (
        ...
        >
            <form onSubmit={formik.handleSubmit}>
                ...
                >
                    <Box>
                        <Text textAlign='center' my={5} fontSize='3xl'>Edit Product</Text>
                    </Box>
                    {/* ---------- Box 1 ---------- */}
                    <Box display='flex'
                    ...
                    >
                        ...
                        <Box width="100%">
                            ...
                            <Select placeholder='select type' isRequired
                                onChange={(e) => setProdCatgory(e.target.value)}>
                    ...
                    <Button bg='#ff914d'
                        ...
                        mt={5}
                        type='submit'
                        isLoading={isLoading}>Update product</Button>
